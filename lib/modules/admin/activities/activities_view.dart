            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _infoRow(Icons.place_rounded, 'Lokasi', k.lokasi ?? '-', accent),
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Icon(Icons.gps_fixed_rounded, color: accent, size: 18),
                        ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${k.latitude!.toStringAsFixed(6)}, ${k.longitude!.toStringAsFixed(6)}',
                                style: GoogleFonts.inter(
                                  fontSize: 14,
                      ...
                      child: SizedBox(
                        ...
                        child: GoogleMap(
                          initialCameraPosition: CameraPosition(
                            target: LatLng(k.latitude!, k.longitude!),
                            zoom: 16,
                          ),
                          markers: {
                            Marker(
                              markerId: const MarkerId('lokasi_kegiatan'),
                              position: LatLng(k.latitude!, k.longitude!),
                              infoWindow: InfoWindow(
                                title: k.namaKegiatan ?? 'Lokasi Kegiatan',
                                snippet: k.lokasi,
                              ),
                            ),
                          },
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Obx(() {
                  final hasLokasi = controller.latitudeSelected.value != null;
                  return Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      if (hasLokasi)
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      controller.alamatSelected.value,
                                      style: GoogleFonts.inter(
                                          fontSize: 13,
                                          fontWeight: FontWeight.w600,
                                          color: AppColors.onSurface),
                                    ...
                                    Text(
                                      '${controller.latitudeSelected.value!.toStringAsFixed(5)}, '
                                      '${controller.longitudeSelected.value!.toStringAsFixed(5)}',
                                      style: GoogleFonts.inter(
                              ...
                              IconButton(
                                ...
                                tooltip: 'Hapus lokasi GPS',
                                onPressed: controller.hapusLokasi,
                              ),
                            ],
                          ),
                        ),
                        ...
                        children: [
                          Expanded(
                            child: OutlinedButton.icon(
                              onPressed: controller.isLoadingLokasi.value
                                  ? null
                                  : controller.ambilLokasiOtomatis,
                              icon: controller.isLoadingLokasi.value
                                  ? const SizedBox(
                                      width: 14,
                                      height: 14,
                                  ...
                                  : Icon(
                                      hasLokasi ? Icons.refresh_rounded : Icons.my_location_rounded,
                                      size: 16,
                                    ),
                              label: Text(
                                controller.isLoadingLokasi.value
                                    ? 'Mendapatkan lokasi...'
                                    : hasLokasi
                                        ? 'Perbarui Lokasi GPS'
                      ...
                      Obx(() {
                        final lat = controller.latitudeSelected.value;
                        final lng = controller.longitudeSelected.value;
                        ...
                        return Column(
                          ...
                          children: [
                            const SizedBox(height: 14),
                            _label('PRATINJAU LOKASI DI PETA'),
                            const SizedBox(height: 8),
                            ClipRRect(
                              borderRadius: BorderRadius.circular(AppDimensions.radiusM),
                              child: SizedBox(
                                ...
                                child: GoogleMap(
                                  ...
                                  markers: {
                                    Marker(
                                      ...
                                      position: position,
                                      infoWindow: InfoWindow(
                                        title: controller.namaCtrl.text.isNotEmpty
                                            ? controller.namaCtrl.text
                                            : 'Lokasi Kegiatan',
                                        snippet: controller.alamatSelected.value,
                                      ),
                                    ),
                                  },
                      ...
                      TextFormField(
                        controller: controller.lokasiCtrl,
                        ...
                        decoration: const InputDecoration(
                          hintText: 'e.g. Balai RT 52 atau isi otomatis via GPS',
                          prefixIcon: Icon(Icons.place_rounded, color: AppColors.outline),
                        ),
                      ),
                    ],
                  );
